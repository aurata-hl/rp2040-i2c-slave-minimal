...
class i2c_slave:
    ...
    def Slave_Write_Data(self, data):
        ...
        self.RP2040_Write_32b_i2c_Reg(
            I2C_OFFSET["I2C_IC_DATA_CMD"],
            data & self.get_Bits_Mask("DAT", I2C_IC_DATA_CMD))
